# Generated by Powerlevel10k configuration wizard on 2026-02-20 at 18:53 IST.
...
# round separators, blurred heads, flat tails, 2 lines, disconnected, left frame,
# darkest-ornaments, compact, many icons, concise, instant_prompt=auto-quiet.
...
# ===== Catppuccin Mocha Color Overrides =====
# Palette reference:
# Base: #1e1e2e
# Surface0: #313244
# Text: #cdd6f4
...
# Multiline ornaments (lavender)
typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%189F╭─'
typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%189F├─'
typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%189F╰─'
...
# Git (green/yellow/red accents)
typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND=108
typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=222
...
# Command execution time (lavender)
typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=189
typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=0
...
# Tooling accents
typeset -g POWERLEVEL9K_ASDF_BACKGROUND=189
...
typeset -g POWERLEVEL9K_GOENV_BACKGROUND=60
typeset -g POWERLEVEL9K_NODENV_BACKGROUND=108
typeset -g POWERLEVEL9K_NVM_BACKGROUND=189
typeset -g POWERLEVEL9K_RBENV_BACKGROUND=203

# Cloud / Kube
typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=189
typeset -g POWERLEVEL9K_AWS_DEFAULT_BACKGROUND=203
typeset -g POWERLEVEL9K_AZURE_OTHER_BACKGROUND=60
typeset -g POWERLEVEL9K_GCLOUD_BACKGROUND=60

# Battery
typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND=203
typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=108
typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=222

# Time (lavender)
typeset -g POWERLEVEL9K_TIME_BACKGROUND=189
typeset -g POWERLEVEL9K_TIME_FOREGROUND=0
# ===== Fix Execution Time Color (Catppuccin Accurate) =====

# Keep clock lavender
typeset -g POWERLEVEL9K_TIME_BACKGROUND=189
typeset -g POWERLEVEL9K_TIME_FOREGROUND=0

# Make execution time peach (distinct from clock)
